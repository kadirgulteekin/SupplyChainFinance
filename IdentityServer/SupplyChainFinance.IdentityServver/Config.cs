...
namespace SupplyChainFinance.IdentityServver
{
    public static class Config
    {
        ...
        {
            new ApiResource("resource_buyer")
            {
                Scopes =
                {
                    "buyer_fullpermission"
                }
            },
            new ApiResource("resource_supplier")
            {
                Scopes =
                {
                    "supplier_fullpermission"
                }
            },
             new ApiResource("resource_financial")
            {
                Scopes =
                {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
              new ApiScope("buyer_fullpermission","Buyer API için full erişim."),
              new ApiScope("supplier_fullpermission","Buyer API için full erişim."),
              new ApiScope("financial_fullpermission","Buyer API için full erişim."),
